...
const myDeviz = 'Never give up'

console.log(myDeviz instanceof String)
console.log(typeof myDeviz)

const myDevizUpperCase = myDeviz.toUpperCase()
console.log(myDevizUpperCase)
